...
namespace LLBLGenLiteExamples.FactoryClasses
{
	...
	{
		private static readonly Dictionary<LLBLGenLiteExamples.EntityType, string> _entityTypeNamesCache = new Dictionary<LLBLGenLiteExamples.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(LLBLGenLiteExamples.EntityType value in Enum.GetValues(typeof(LLBLGenLiteExamples.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(LLBLGenLiteExamples.EntityType), value));
			}
		}	
		...
		public static IEntityFields2 CreateEntityFieldsObject(LLBLGenLiteExamples.EntityType relatedEntityType)
		{
