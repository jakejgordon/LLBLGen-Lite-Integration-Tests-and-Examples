...
namespace LLBLGenLiteExamples.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		/// <summary>Creates and returns a new EntityQuery for the Pet entity</summary>
		public EntityQuery<PetEntity> Pet
		{
			get { return Create<PetEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the PetFoodBrand entity</summary>
		public EntityQuery<PetFoodBrandEntity> PetFoodBrand
		{
			get { return Create<PetFoodBrandEntity>(); }
		}
